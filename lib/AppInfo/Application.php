...
use OCA\Mail\Listener\MailFullTextSearchListener;
...
final class Application extends App implements IBootstrap {
	...
	public function register(IRegistrationContext $context): void {
		...
		$context->registerEventListener(NewMessagesSynchronized::class, MailFullTextSearchListener::class);
		$context->registerEventListener(MessageDeletedEvent::class, MailFullTextSearchListener::class);
		$context->registerEventListener(MessageFlaggedEvent::class, MailFullTextSearchListener::class);
